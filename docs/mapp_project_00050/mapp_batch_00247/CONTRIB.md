...
```bash
sg commons-users -c './copy_files.sh -i /mnt/bigdata/mapp/public/QE_HFX_unifr/converted -o /msdata/mapp_project_00050/mapp_batch_00247 -p "*20260428_CVOL_Group_01*.mzML"'
```
...
paths:
  ...
  input_folder: /Users/pma/git_repos/commons-teaching/group-01/docs/mapp_project_00050/mapp_batch_00247/results/met_annot_enhancer # The path were you want your GNPS job folder to be placed
  ...
  output_folder: /Users/pma/git_repos/commons-teaching/group-01/docs/mapp_project_00050/mapp_batch_00247/results/met_annot_enhancer # the path for your output to be stored in
...
```yaml
paths:
  docs: '/Users/pma/git_repos/commons-teaching/group-01/docs'
  output: '/Users/pma/git_repos/commons-teaching/group-01/docs/mapp_project_00050/mapp_batch_00247/results/stats' # Not mandatory, default is in the stats subdirectory
...
dataset_experiment : 
  ...
  description: "Untargeted metabolomics, tp26 SBL. 200004, group-01 - C18"
